...
inline constexpr std::string_view kActionsListChanged = "actions/list_changed";
inline constexpr std::string_view kResourcesListChanged = "resources/list_changed";
